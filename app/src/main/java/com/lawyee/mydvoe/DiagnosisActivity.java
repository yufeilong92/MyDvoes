...
import com.lawyee.mydvoe.cloud.ClickAction;
import com.lawyee.mydvoe.cloud.Style;
import com.lawyee.mydvoe.cloud.TimeInterval;
import com.lawyee.mydvoe.cloud.XingeApp;
import com.lawyee.mydvoe.common.CommonWorkingThread;
import com.lawyee.mydvoe.common.ExtendedListView;
...
//		}
	...
	private void step7() {
		...
		int ret_code = 0;
		try {
			com.lawyee.mydvoe.cloud.Message message = new com.lawyee.mydvoe.cloud.Message();
			message.setType(com.lawyee.mydvoe.cloud.Message.TYPE_NOTIFICATION);
